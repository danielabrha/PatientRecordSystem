...
public class User extends Person {
    ...
    public User(String fName, String lName, String mName, String gender, String email, String phoneNumber, String address, Date dateOfBirth, int userId, String userName,String password, List<Role> roleList, Doctor doctor, Receptionst receptionst, Laboratorist laboratorist, SystemAdmin systemAdmin) {
    ...
    public User(String fName, String lName, String mName, String gender, String email,
                String phoneNumber, String address, Date dateOfBirth, String userName,String password, List<Role> roleList, Doctor doctor, Receptionst receptionst, Laboratorist laboratorist, SystemAdmin systemAdmin) {
        super(fName, lName, mName, gender, email, phoneNumber, address, dateOfBirth);
        this.userName = userName;
        this.password=password;
        this.roleList = roleList;
