...
public interface ILabOrderService {
    ...
    public LabOrder update(LabOrder labOrder, int visitId,
                           int labTestTypeId);
    public void deleteById(int id);
    public void delete(LabOrder labOrder);
    public void deleteAll(Iterable<LabOrder> labOrders);
    public void deleteAll();
    public LabOrder create(int visitId, int labTestTypeId);
    public List<LabOrder> createAll(List<LabOrder> listLabOrder, int visitId,
                                    int labTestTypeId);
}
